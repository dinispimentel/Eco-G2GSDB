...
from G2G.G2GOffer import Offer
from G2G.G2GFilterOffer import FilterOffer
from config import Config



with open("./price_filtering.json", "r") as __file:
...
class G2GScraper:
    ...
    def updateModuleConfigs():
        with open("./price_filtering.json", "r") as _file:
    ...
    def updateAccountCache():
        ...
        with open("./cache/accounts-unfiltered.json", "w") as file:
